...
DROP INDEX IF EXISTS uniq_user_dept_roles_active_global;
DROP INDEX IF EXISTS uniq_user_dept_roles_active_dept;
DROP INDEX IF EXISTS uniq_dept_product_approvals_active;
DROP INDEX IF EXISTS uniq_device_assignments_active;
DROP INDEX IF EXISTS uniq_user_assignments_active;
